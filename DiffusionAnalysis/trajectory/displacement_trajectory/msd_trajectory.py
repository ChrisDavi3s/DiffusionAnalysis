...
class MSDTrajectory(BaseDisplacementTrajectory):
    """
    ...
    def __init__(self,
        ...
        super().__init__(msd_data, tracer_specs, framework_specs, atoms_map, time_data, trajectory_type, is_com, is_drift_corrected)
